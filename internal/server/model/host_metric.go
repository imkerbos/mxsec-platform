...
type HostMetric struct {
	...
	CollectedAt  time.Time `gorm:"column:collected_at;type:timestamp;not null;index:idx_host_collected;index:idx_collected_at" json:"collected_at"`
}
...
type HostMetricHourly struct {
	...
	HourStart         time.Time `gorm:"column:hour_start;type:timestamp;not null;index:idx_host_hour" json:"hour_start"`
}
